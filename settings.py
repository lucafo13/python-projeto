...
# Pokemon settings
POKEMON_LIST = ['Diglett', 'Charmander', 'Bellsprout', 'Dratini', 'Bulbasaur', 'Squirtle', 'Pikachu', 'Pidgey']
TYPE_LIST = ['grass', 'fire', 'water', 'eletric', 'flying','ground']
...
#meus vai ser os mesmo msm
ELETRIC_ATTACK_IMG = 'fire_attack.png'
FLYING_ATTACK_IMG = 'water_attack.png'
